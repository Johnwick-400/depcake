    ...
    <div class="container-fluid bg-dark bg-img p-5 mb-5">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <i class="far fa-square text-primary px-2"></i>
                <a href="Truffle_chocolate.php">Truffle Chocolate</a>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div id="tab-1" class="tab-pane fade show p-0 active">
            <div class="row g-3 justify-content-center">
                ...
                <div class="card mx-auto text-center p-3" style="width: 18rem;">
                    <img src="img\flavours\Depadya Cake.svg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Truffle Chocolate Cake</h5>
                        <p class="card-text">Weight available: 500g to 2kg. Custom size available on request.</p>
                        <a href="buyoption.php?id=3" class="btn btn-primary">Buy Now</a>
                    </div>
                </div>
